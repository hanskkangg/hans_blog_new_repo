...
export default function PostPage() {
  ...
  useEffect(() => {
    const fetchPost = async () => {
      ...
      try {
        ...
        if (recentRes.ok) {
          const filteredRecentPosts = recentData.posts
        ...
        if (postData._id) {
          const updateRes = await fetch(
            `/api/post/increment-views/${postData._id}`,
            {
              method: "PUT",
  ...
  return (
    <main className="p-3 flex flex-col max-w-6xl mx-auto min-h-screen overflow-x-hidden bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-200">
      ...
      <div className="p-5 bg-white dark:bg-gray-800 rounded-lg shadow-md max-w-2xl mx-auto mt-10 flex flex-col items-center text-center">
        ...
        <div className="mt-4">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">
            Hans Kang{" "}
            <span className="text-gray-500 dark:text-gray-400">(he/him)</span>
          </h2>
          <p className="text-sm text-gray-600 dark:text-gray-300">
            Web Developer | DevOps & SRE | Tech Enthusiast | Loves Coffee &
            Movies ❤️
          </p>
          ...
          <div className="flex gap-4 mt-2 justify-center">
            ...
            <a
              href="https://www.linkedin.com/in/hanskkang"
              target="_blank"
              rel="noopener noreferrer"
            >
